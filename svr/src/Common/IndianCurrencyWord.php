...
//$obj=new IndianCurrency(0.13);
//echo $obj->get_words();

class IndianCurrencyWord
{
  ...
  public function get_words(float $amount): string
  {
  ...
  private function single_word($n, $txt): string
  {
//    $t="";
    if ($n <= 19) {
  ...
  private function words_array($num): string
  {
